...
<head>
    ...
    <title>Fiche de Suivi de la Machine</title>
    <style>
        body {
...
<body>
    @include('pdf.partials.pdf-header', ['machine' => $machine])
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="9" style="text-align: center;">Aucun suivi trouvé pour cette machine.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
