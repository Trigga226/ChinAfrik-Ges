...
namespace App\Filament\Cam\Resources\CategorieCamionResource\RelationManagers;
...
class CamionsRelationManager extends RelationManager
{
    protected static string $relationship = 'camions';
